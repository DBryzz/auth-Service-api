    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && jwtTokenValidator.validateToken(jwt)) {
                Long userId = jwtTokenProviderUtil.getUserIdFromJWT(jwt);
                List<GrantedAuthority> authorities = jwtTokenProviderUtil.getAuthoritiesFromJWT(jwt);
//                List authorities = Collections.singletonList(jwtTokenProviderUtil.getAuthoritiesFromJWT(jwt));
