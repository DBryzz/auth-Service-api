...
public class JwtTokenProviderUtil {
    ...
    public JwtTokenProviderUtil(@Value("${app.jwt.secret}") String jwtSecret, @Value("${app.jwt.expiration}") long jwtExpirationInMs) {
    ...
    public String generateToken(UserDetailsImpl userDetailsImpl) {
        ...
        String authorities = getUserAuthorities(userDetailsImpl);
        return Jwts.builder()
     ...
     */
    private String getUserAuthorities(UserDetailsImpl userDetailsImpl) {
