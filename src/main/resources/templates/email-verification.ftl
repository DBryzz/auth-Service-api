                    ...
                    <table style="background: #ffffff; border: 0px; border-radius: 4px; width: 99.6672%; overflow: hidden;"
                        ...
                        <tr>
                            <td class="" style="padding: 0px; width: 100%;" align="center">
                                <table style="background: #26a69a; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                       cellspacing="0" cellpadding="0">
                                    <tbody>
                                    <tr>
                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Thank you for joining <strong>Auth Service</strong>, an efficient API for securing your application</span><br/><br/><span
                                                ...
                                                <tr>
                                                    <td>
                                                        <table class="button mobile-w-full"
                                                               style="border: 0px; border-radius: 7px; margin: 0px auto; width: 525px; background-color: #26a69a; height: 50px;"
...
<#--                                                question</a></p>-->
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Regards, <br/>Auth Service Team</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
